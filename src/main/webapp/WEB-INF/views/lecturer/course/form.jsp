...
<acme:form>
	...
	<acme:input-select code="lecturer.course.form.label.courseType" path="courseType" choices="${courseTypes}"/>
	...
	<jstl:if test="${acme:anyOf(_command, 'show|update|delte|publish') && draftMode == true}">
